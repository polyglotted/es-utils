...
public class ExtnGenerator {
    ...
    private static final ImmutableMap<Class<?>, String> SearchClasses = ImmutableMap.<Class<?>, String>builder()
       .put(Expression.class, "search expression").put(Alias.class, "index alias")
       .put(IndexSetting.class, "index settings").put(IndexAction.class, "index action constants")
       .put(IndexAdmin.class, "index admin").put(FieldMapping.class, "index field mapping")
       .put(TransformScript.class, "transformation script").put(TypeMapping.class, "type mapping")
       .put(IndexKey.class, "index key").put(SleeveDoc.class, "indexing sleeve")
       .put(SortOrder.class, "sort order constants").put(SortMode.class, "sort mode constants")
       .put(Sort.class, "simple sort").put(SearchOptions.class, "search options constants")
       .put(SearchType.class, "search type constants").put(QueryHints.class, "query hints")
       .put(Aggregation.class, "search aggregation").put(Bucket.class, "aggregation buckets")
       .put(ResponseHeader.class, "search response header").put(SimpleDoc.class, "simple search document")
       .put(Flattened.class, "flattened search aggregation").put(StandardQuery.class, "standard search query")
       .put(StandardScroll.class, "standard scroll query").put(QueryResponse.class, "search query response")
       .build();

    private static final ImmutableMap<Class<?>, List<String>> Requireds = ImmutableMap.<Class<?>, List<String>>builder()
       .put(Expression.class, asList("operation", "label")).put(Alias.class, asList("alias", "remove"))
       .put(IndexAdmin.class, asList("index", "action")).put(FieldMapping.class, asList("field", "include"))
       ...
       .put(ResponseHeader.class, asList("millis", "hits", "returned")).put(SimpleDoc.class, singletonList("key"))
       .put(StandardQuery.class, asList("hints", "offset", "size")).put(StandardScroll.class, asList("id", "scroll"))
